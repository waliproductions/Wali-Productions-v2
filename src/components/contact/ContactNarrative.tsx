...
/**
 * Shared narrative layout for the text-heavy Contact sections (overview and
 * client promise summary). Reuses the homepage Section primitive for aligned
 * spacing/width. Authors no content.
 */

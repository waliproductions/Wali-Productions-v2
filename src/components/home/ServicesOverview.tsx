        ...
        <ul className="mt-14 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3" role="list">
          {ALL_SERVICES.map((service, i) => (
            <motion.li
              ...
              className="group relative flex flex-col rounded-2xl border border-black/8 bg-white p-7 shadow-card transition-all duration-300 hover:border-[#4A7DB5]/30 hover:shadow-card-hover dark:border-white/8 dark:bg-white/[0.03] dark:hover:bg-white/[0.05]"
            >
              {/* Icon */}
              ...
              <div className="mt-5 flex items-center gap-2 border-t border-black/8 pt-4 dark:border-white/8">
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="shrink-0 text-[#4A7DB5]" aria-hidden="true">

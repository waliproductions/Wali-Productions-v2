...
export function PortfolioCallToAction() {
  ...
  return (
    <section aria-labelledby="portfolio-cta-heading" className="relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute -left-40 top-0 h-[400px] w-[400px] rounded-full bg-[#4A7DB5] opacity-10 blur-3xl" aria-hidden="true" />
